...
#For simplicity, the tRF sequences were accessed March 11, 2022 and uploaded to github and may be downloaded using the following code:
	...
	wget https://raw.githubusercontent.com/Meffert-Lab/PACeR/main/mouse_tRF-1.csv -O ${reference_directory}mouse_tRF-1.csv
	wget https://raw.githubusercontent.com/Meffert-Lab/PACeR/main/mouse_tRF-3.csv -O ${reference_directory}mouse_tRF-3.csv
	wget https://raw.githubusercontent.com/Meffert-Lab/PACeR/main/mouse_tRF-5.csv -O ${reference_directory}mouse_tRF-5.csv
